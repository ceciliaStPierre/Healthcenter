...
u5 = User.create(firstname: "Cecilia", secondname: ".", father_lastname: "Saint-Pierre", mother_lastname: ".", phone_number: 90000004, speciality: "Ingeniería", email: "csaintpierre@gmail.com", password: "123123123", password_confirmation: "123123123", avatar: "http://rotarymeansbusiness.com/wp-content/uploads/avatar-female.png", is_admin: true, program: "Administración", sector: "Todos"  )
